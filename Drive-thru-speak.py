# -*- coding: utf-8 -*-
"""
Created on Sat July 22 05:00:00 2023

@author: Nishant Verma (NV185055)
"""
...
def main_screen(): #Function to define the main screen of the GUI
  ...
  global load1
  global load2
  screen.title("Drive-Thru Speak")
  #Load images into variables
  load = PhotoImage(file="Mainmenu.png")
  load1 = PhotoImage(file="hot.png")
  load2 = PhotoImage(file="Burger.png")
  #Define labels
